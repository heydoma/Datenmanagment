...
ist es jedoch häufig unabdingbar die Modelle nachzutrainieren (sog. ''Retraining''),
...
Zusätzlich führt die gerichtete Kante von der Sandbox
zurück in den Data Lake.
Dadurch wird gekennzeichnet, dass die Trainingsdaten des KI-Modells
im Data Lake persistiert werden, bevor der Datenbestand der Sandbox gelöscht wird.
Das Vorhalten der Trainingsdaten kann z.B. wichtig sein für
die Anwendung von post-hoc Explainability Methoden, 
bei denen häufig Zugriff auf die Trainingsdaten benötigt wird~\cite{pintelas2020}.
