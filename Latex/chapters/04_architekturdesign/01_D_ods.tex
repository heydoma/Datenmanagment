...
% Aufgrund der hohen Aktualitätsanforderung wäre grundsätzlich auch
% Real-Time-Processing denkbar. Für diesen Anwendungsfall ist jedoch keine
% kontinuierliche Verarbeitung erforderlich, da die Einschätzung des KI-Modells
% erst bei der aktiven Bearbeitung eines vollständig vorliegenden Schadensfalls
% angefragt wird. Die fallbezogene und hochaktuelle Bereitstellung der Daten
% über den ODS ist deshalb ausreichend.
...
% Optional zur Präzisierung: Die Historisierung erfolgt zusätzlich und unabhängig
% vom ODS über die regulären Ladewege in Data Warehouse und Data Lake.
